...
parser.add_argument('--nz', type=int, default=256)              # input dimension of noise.
parser.add_argument('--ngf', type=int, default=256)             # feature dimension of final layer of generator.
...
parser.add_argument('--trns_tick', type=int, default=1)       # transition tick
parser.add_argument('--stab_tick', type=int, default=1)       # stabilization tick
